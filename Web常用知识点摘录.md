...
highlight_file(arg)可以高亮文件arg中的代码

## show_source()

show_source(arg)可以显示文件arg的源代码

## call_user_func()

call_user_func(arg1, arg2)函数接收函数arg1进行执行，arg1函数的参数为arg2

### 绕过

如果题目对arg1函数名进行了过滤，可以在arg1前加上 `\` 特殊字符进行绕过
